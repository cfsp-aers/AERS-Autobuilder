                                        ...
                                        children: [
                                            {
                                                ...
                                                padding: "8px",
                                                mobile_stack: false,
                                                children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/pb-fb.png", href: "https://www.facebook.com/petbarn", aem_id: "urn:aaid:aem:2bb931cf-f45f-424a-9ea0-68b755a721dc" } }]
                                            },
                                            {
                                                block: "gridCol",
                                                padding: "8px",
                                                mobile_stack: false,
                                                children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/pb-in.png", href: "https://www.instagram.com/petbarn/#", aem_id: "urn:aaid:aem:1f1fa734-3055-4fca-ab50-a393b9951fea" } }]
                                            },
                                            {
                                                block: "gridCol",
                                                padding: "8px",
                                                mobile_stack: false,
                                                children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/pb-yt.png", href: "https://www.youtube.com/channel/UCMmNH-oEDpTqkcEbegRRvUQ", aem_id: "urn:aaid:aem:b7cfe5a0-2e25-48b2-9837-247d078ba7e8" } }]
                                            },
                                            {
                                                block: "gridCol",
                                                padding: "8px",
                                                mobile_stack: false,
                                                children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/pb-tt.png", href: "https://www.tiktok.com/@petbarnau", aem_id: "urn:aaid:aem:ddbf85b9-7fe7-4874-abcb-14e6a0855d48" } }]
                                            }
                                        ]
                                    }
                                ]
