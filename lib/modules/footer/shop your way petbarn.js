...
const internal_layout = (current, content) => {
    return {
        ...
        children: [
            {
                block: "gridCol",
                padding: current.transition ? "0px 0px 24px" : "24px 0px 24px",
                children: [
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        children: [
                                                            ...
                                                            { entity_type: "component", colour: "black", font_size: "14px", line_height: "16px", content: "Free on orders over $159" }
                                                        ]
                                                    },
                                                    {
                                                        block: "gridCol",
