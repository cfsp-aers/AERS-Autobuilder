...
const internal_layout = (current, content) => {
    return {
        ...
        children: current.transactional
            ? [{ block: "gridRow", children: [{ block: "gridCol", padding: "24px 32px 32px", children: [{ entity_type: "component", colour: "white", font_size: "12px", line_height: "14px", content: `transactional footer` }] }] }]
            : [
                  {
                      block: "gridRow",
                      children: [
                                                      ...
                                                      children: [
                                                          {
                                                              ...
                                                              padding: "8px",
                                                              mobile_stack: false,
                                                              children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/gxv-fb.png", href: "https://www.facebook.com/GreencrossVets/" } }]
                                                          },
                                                          {
                                                              block: "gridCol",
                                                              padding: "8px",
                                                              mobile_stack: false,
                                                              children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/gxv-in.png", href: "https://www.instagram.com/greencrossvets/" } }]
                                                          },
                                                          {
                                                              block: "gridCol",
                                                              padding: "8px",
                                                              mobile_stack: false,
                                                              children: [{ entity_type: "component", type: "image", width: "32px", content: { src: "images/gxv-yt.png", href: "https://www.youtube.com/user/Greenxvets" } }]
                                                          }
                                                      ]
                                                  }
                                              ]
