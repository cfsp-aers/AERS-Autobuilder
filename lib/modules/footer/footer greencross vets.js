...
const internal_layout = (current, content) => {
    return {
        ...
        children: current.transactional
            ? [{ block: "gridRow", children: [{ block: "gridCol", padding: "0px 32px 32px", children: [{ entity_type: "component", colour: "white", font_size: "12px", line_height: "14px", content: `transactional footer` }] }] }]
            : [
                  {
                      block: "gridRow",
                      children: [
