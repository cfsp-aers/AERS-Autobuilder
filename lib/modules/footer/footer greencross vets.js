...
const internal_layout = (current, content) => {
    return {
        ...
        children: current.transactional
            ? [{ block: "gridRow", children: [{ block: "gridCol", padding: "16px 32px 32px", children: [{ entity_type: "component", colour: "white", font_size: "12px", line_height: "14px", content: `This designated commercial electronic message is sent by Greencross Pty Ltd in accordance with Schedule 1 of the Spam Act 2003 (Cth).` }] }] }]
            : [
                  {
                      block: "gridRow",
                      children: [
